...
def load_and_plot_point_time_series(time_step_label, lon_idx, lat_idx):
    print(
        f"Selected time step: {time_step_label} at point (lon_idx={lon_idx}, lat_idx={lat_idx})"
    )
    ...
    fig.savefig(
        f"3_observing_system_simulation_experiment/outputs/osse_point_time_step_{time_step_label}.png",
        bbox_inches="tight",
        dpi=300,
    )
    pass
...
def main():
    ...
    print("\nPoint time series figure generated and saved")
