...
def main():
    ...
    fig.savefig(
        "4_satellite_application/figures/satellite_case_1_prediction.png",
        bbox_inches="tight",
        dpi=300,
    )
    ...
    fig.savefig(
        "4_satellite_application/figures/satellite_case_1_rossby_number.png",
        bbox_inches="tight",
        dpi=300,
    )
    print("Rossby number figure saved.")
